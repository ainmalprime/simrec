...
describe "flow_sheet_records/new" do
  before(:each) do
    assign(:flow_sheet_record, stub_model(FlowSheetRecord,
      :visit_id => 1,
      :temp => "MyString",
  ...
  it "renders new flow_sheet_record form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => flow_sheet_records_path, :method => "post" do
