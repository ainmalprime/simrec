...
describe "image_files/new" do
  before(:each) do
    assign(:image_file, stub_model(ImageFile,
  ...
  it "renders new image_file form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => image_files_path, :method => "post" do
