...
describe "site_configurations/new" do
  before(:each) do
    assign(:site_configuration, stub_model(SiteConfiguration,
  ...
  it "renders new site_configuration form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => site_configurations_path, :method => "post" do
