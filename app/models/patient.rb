class Patient < ActiveRecord::Base
  attr_accessible :address, :dateOfBirth, :drugAllergies, :firstName, :insuranceCarrier, :last_name, :middleInitial, :patientNumber, :primaryCarePhysician, :telephone1, :telephone1type, :telephone2, :telephone2type, :image_file_id
